    ...
    jumptap: function(e) {
      ...
      switch (linkData) {
        ...
        case 6:
          ...
          let wxltype = this.properties.adpicUrls.content.dataset[index].wxlinkType
          if (wxltype == 1) {
            wx.switchTab({
              url: '/' + link
            })
        ...
        case 7:
          var link = this.properties.adpicUrls.content.dataset[index].wxlink
          var wxltype = this.properties.adpicUrls.content.dataset[index].wxlinkType
          if (wxltype == 1) {
            wx.switchTab({
              url: '/' + link
            })
        ...
        case 14:
          var id = this.properties.adpicUrls.content.dataset[index].item_id
          var wxlink = this.properties.adpicUrls.content.dataset[index].wxlink
          wx.navigateTo({
            url: '/' + wxlink + '?id=' + id
          })
          break;
